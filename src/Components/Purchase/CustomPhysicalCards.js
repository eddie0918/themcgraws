  ...
  async componentDidMount() {
    this.setState({
      cardTypesList: (await GetCustomPhysicalCardTypes()).map(cpc => ({
        CustomPhysicalCardsTypeId: cpc.CustomPhysicalCardsTypeId,
        CustomPhysicalCardsTypeName: cpc.CustomPhysicalCardsTypeName,
        CustomAreaSizeText: cpc.CustomAreaSizeText,
        ImageUrl: `/images/${cpc.CustomPhysicalCardsTypeName}.svg`,
        Denomination: null,
        Quantity: null,
        Type: null
      })),
